...
import DARK_GLASS_THEME from './dark-glass';
import { LIGHT_GLASS_THEME } from './loght-glass';

function getThemeByDarkMode(darkMode: boolean) {
  return darkMode ? createTheme(DARK_GLASS_THEME) : createTheme(LIGHT_GLASS_THEME);
}
